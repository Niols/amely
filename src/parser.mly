...
| lhb=lilypond_header_body a=assignment                { LilyondHeaderBody_LilypondHeaderBody_Assignment (lhb, a) }
...
assignment:
| assignment_id EQUAL identifier_init                    { Assignment_AssignmentId_EQUAL_IdentifierInit (ai, ii) }
// | assignment_id DOT property_path EQUAL identifier_init
// | assignment_id COMMA property_path EQUAL identifier_init
;

identifier_init:
| identifier_init_nonumber                             { IdentifierInit_IdentifierInitNonumber iin }
// | number_expression
...
// | pitch_or_music
// | FRACTION
| s=cstring                                            { IdentifierInitNonumber_Cstring s }
// | embedded_scm
// | partial_markup
// | full_markup_list
